...
(function() {
  var $board, BLACK, BOARD_SIZE, EMPTY, EvaluationResult, MAX_SCORE, OnBoard, WHITE, adjacenciesAt, bgmPause, cancelWaiting, computerPlay, currentIndex, evalUntilDepth, evaluate, expected, key, modalTime, opponentOf, showOnBoard, userPlayAndResponse, userStone, value, waitForUserPlay;
        ...
        for (y = _j = 0; 0 <= BOARD_SIZE ? _j < BOARD_SIZE : _j > BOARD_SIZE; y = 0 <= BOARD_SIZE ? ++_j : --_j) {
          ...
          if (blacks.some(function(e) {
            ...
            if (effect && ((!$intersection.hasClass('black')) || $intersection.hasClass('half-opacity'))) {
              ...
              _results1.push($intersection.addClass('black').removeClass('white half-opacity'));
            }
            ...
            if (effect && ((!$intersection.hasClass('white')) || $intersection.hasClass('half-opacity'))) {
              ...
              _results1.push($intersection.addClass('white').removeClass('black half-opacity'));
            }
          } else {
