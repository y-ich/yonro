...
test: test/test-bit-board.coffee test/test-go-evaluate-bit-board.coffee go-common.coffee bit-board.coffee go-evaluate.coffee
	mocha -b --compilers coffee:coffee-script/register --timeout 1000000
